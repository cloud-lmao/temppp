...
import { Moon, Sun, ArrowUp, Eye, BookOpen, Shuffle, Network, Route } from 'lucide-react';
import Header from './components/Header';
import SwitchingIntro from './components/SwitchingIntro';
import CircuitSwitching from './components/CircuitSwitching';
import PacketSwitching from './components/PacketSwitching';
import SwitchingComparison from './components/SwitchingComparison';
import SwitchingDevices from './components/SwitchingDevices';
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800 transition-all duration-500">
        ...
        <main className="pt-16 sm:pt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
            ...
            <div className="text-center mb-12 sm:mb-16">
              <div className="mb-6 sm:mb-8">
                ...
                <p className="text-lg sm:text-xl md:text-3xl text-gray-700 dark:text-gray-200 mb-3 sm:mb-4 font-medium px-4">
                  Day 4: Circuit & Packet Switching
                </p>
                <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto px-4">
                  Learn how networks decide the best path for your data - from phone calls to internet browsing
                </p>
              </div>
              ...
              <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-8 mb-12 sm:mb-16 border border-gray-200 dark:border-gray-600 mx-2 sm:mx-0">
                <h2 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">
                  🔀 Why Learn Switching Techniques?
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                  <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl sm:rounded-2xl">
                    <Shuffle className="w-8 h-8 sm:w-12 sm:h-12 text-blue-600 mx-auto mb-3 sm:mb-4" />
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-sm sm:text-base">Data Flow Control</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-xs sm:text-sm">
                      Understand how networks manage millions of data flows simultaneously
                    </p>
                  </div>
                  <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl sm:rounded-2xl">
                    <Network className="w-8 h-8 sm:w-12 sm:h-12 text-purple-600 mx-auto mb-3 sm:mb-4" />
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-sm sm:text-base">Network Design</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-xs sm:text-sm">
                      Learn why phone calls are different from internet browsing
                    </p>
                  </div>
                  <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-800/30 rounded-xl sm:rounded-2xl">
                    <Route className="w-8 h-8 sm:w-12 sm:h-12 text-indigo-600 mx-auto mb-3 sm:mb-4" />
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-sm sm:text-base">Performance</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-xs sm:text-sm">
                      Understand why some apps need guaranteed speed while others don't
                    </p>
                  </div>
                </div>
              </div>
            ...
            <SwitchingIntro learningMode={learningMode} isDarkMode={isDarkMode} />

            {/* Circuit Switching */}
            <CircuitSwitching learningMode={learningMode} isDarkMode={isDarkMode} />

            {/* Packet Switching */}
            <PacketSwitching learningMode={learningMode} isDarkMode={isDarkMode} />

            {/* Switching Comparison */}
            <SwitchingComparison learningMode={learningMode} isDarkMode={isDarkMode} />

            {/* Switching Devices */}
            <SwitchingDevices learningMode={learningMode} isDarkMode={isDarkMode} />
          </div>
        </main>
